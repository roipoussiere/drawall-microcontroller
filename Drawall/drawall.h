...
class Drawall {
    ...
    **********************/
     ...
     */
    void cubicCurveAbs(float pX, float pY, float p1X, float p1Y, float p2X, float p2Y);
     ...
     */
    void cubicCurveRel(float pX, float pY, float p1X, float p1Y, float p2X, float p2Y);
     ...
     */
    void cubicCurveAbs(float pX, float pY, float p2X, float p2Y);
     ...
     * \param p2Y La position relative verticale du point de contrôle P2.
     */
    void cubicCurveRel(float pX, float pY, float p2X, float p2Y);
     ...
     * \param p1Y La position absolue verticale du point de contrôle P1.
     */
    void quadraticCurveAbs(float pX, float pY, float p1X, float p1Y);
     ...
     * \param p1Y La position relative verticale du point de contrôle P1.
     */
    void quadraticCurveRel(float pX, float pY, float p1X, float p1Y);
     ...
     * \param pY La position absolue verticale du point de destination.
     */
    void quadraticCurveAbs(float pX, float pY);
     ...
     * \param pY La position relative verticale du point de destination.
     */
    void quadraticCurveRel(float pX, float pY);
        
    /**
     * \brief Trace un arc de cercle en position absolue.
     * \todo Remplir la fonction.
     */
    void arcAbs(float a1, float a2, float a3, float a4, float a5, float a6, float a7);
